...
snapshots["test_signup[hi-True-400] 1"] = {
    "data": None,
    "message": """Parameter validation failed:
Invalid length for parameter Password, value: 2, valid range: 6-inf""",
}

snapshots["test_signup[H3l!o W-True-400] 1"] = {
    "data": None,
...
snapshots["test_signup[h3llo world!-True-400] 1"] = {
    "data": None,
    "message": "The password must be at least 8 characters long, have both upper and lower case letters, and at least one special character.",
}
...
snapshots["test_signup[H3llo World!-False-400] 1"] = {
    "data": None,
    "message": "Invalid invitation code. Please contact an administrator.",
}

snapshots["test_signup[H3llo World!-True-200] 1"] = {
    "data": None,
...
snapshots["test_confirm_signup[confirmed-False-200] 1"] = {
    "data": None,
    "message": "User is already confirmed.",
}

snapshots["test_confirm_signup[unconfirmed-False-400] 1"] = {
    "data": None,
...
snapshots["test_reset_password[confirmed-True-400] 1"] = {
    "data": None,
    "message": "Verification code has expired. Please request a new verification code from the forgot password page.",
}
